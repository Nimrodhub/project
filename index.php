...
<html lang="en">
  ...
  <a class="navbar-brand" href="#">OLSRS</a>
...
<section id="carosul_section">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="images/img (2).jpg" height="450px" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/img (9).jpg" height="450px" alt="Third slide">
    </div>
  </div>
          ...
          <div class="col-md-4">
               <div class="first_ft">
                ...
                <ul>
                  <li>Mail: ...</li>
                  <li>Contacts: ... </li>
                  <li>Link: <a href="https://github.com/Nimrodhub" target="_blank">Nimrodhub</a></li>
                  <li>Website: ... </li>
                </ul>
              </div>
          </div>
